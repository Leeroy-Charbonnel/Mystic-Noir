...
export class TimelineView extends ItemView {
    ...
    private renderCalendarGrid(timelineData: TimelineData): void {
        ...
        events.forEach(event => {
            ...
            switch(event.type) {
                case 'story':
                    bgColor=this.plugin.settings.storyColor;
                    break;
                case 'event':
                    bgColor=this.plugin.settings.eventColor;
                    break;
                case 'character':
                    bgColor=this.plugin.settings.characterColor;
                    break;
                case 'characterEvent':
                    bgColor=this.plugin.settings.characterEventColor;
                    break;
            }

            eventEl.style.setProperty('--background-color',bgColor);
            eventEl.style.setProperty('--background-transparent-color',bgColor+"50");//Add transparency
            eventEl.style.setProperty('--border-color',bgColor);
